...
public class DateTools {
    ...
    @Tool(description = """
            Returns today's date, day of week, and the exact dates for each of the next 14 days.
            Always call this tool before scheduling any event so you use the correct date for
            expressions like 'next Wednesday', 'this Friday', or 'in 3 days'.
            """)
